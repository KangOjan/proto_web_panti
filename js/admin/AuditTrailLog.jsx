// Digital Audit Trail Log Component for SIMK-Panti
const AuditTrailLog = ({ auditLogs }) => {
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full sm:w-64">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-1.5 rounded-xl border border-slate-300 text-xs font-medium focus:ring-2 focus:ring-slate-900"
          />
        </div>
      </div>
...
window.AuditTrailLog = AuditTrailLog;
